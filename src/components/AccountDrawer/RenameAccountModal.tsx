...
import { Button, FormControl, FormErrorMessage, FormLabel, Input, ModalBody, ModalCloseButton, ModalContent, ModalFooter } from "@chakra-ui/react";
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <ModalBody>
                    <FormControl marginY={5} isInvalid={!!errors.name}>
                        ...
                        />
                        {errors.name && <FormErrorMessage data-testid="name-error">{errors.name.message}</FormErrorMessage>}
                    </FormControl>
