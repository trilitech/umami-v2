...
describe("stakingHooks", () => {
  ...
  test("useGetFirstFinalizableCycle", () => {
    ...
    } = renderHook(() => useGetFirstFinalizableCycle());
  ...
  test("useAccountPendingUnstakeRequests", () => {
    ...
    } = renderHook(() => useAccountPendingUnstakeRequests(address));
    ...
    } = renderHook(() => useAccountPendingUnstakeRequests(mockImplicitAddress(1).pkh));
  ...
  describe("useAccountTotalFinalizableUnstakeAmount", () => {
    it("returns 0 if a user doesn't have any finalizable unstakes", () => {
      ...
      } = renderHook(() => useAccountTotalFinalizableUnstakeAmount(address));
