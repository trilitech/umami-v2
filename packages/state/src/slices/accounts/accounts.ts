...
export const accountsSlice = createSlice({
  ...
  reducers: {
    ...
    /**
     * For mnemonics used as a part of {@link @umami/core#useDeriveMnemonicAccount} hook (for setting unique account name).
     * */
     ...
     * Used as a part of {@link @umami/core#useRestoreRevealedMnemonicAccounts} hook (for setting unique account names inside the group).
     * */
    addMnemonicAccounts: (
      state,
      {
