...
export type AllArticlesQuery = {
  ...
  _allArticlesMeta: { __typename?: "CollectionMetadata"; count: number };
};

export const AllArticlesDocument = {
  kind: "Document",
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          ...
          {
            kind: "Field",
            name: { kind: "Name", value: "_allArticlesMeta" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
...
} as unknown as DocumentNode<AllArticlesQuery, AllArticlesQueryVariables>;
